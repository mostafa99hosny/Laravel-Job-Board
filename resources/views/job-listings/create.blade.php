                    ...
                    <form method="POST" action="{{ route('job-listings.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="salary_min" class="block mt-1 w-full" type="number" name="salary_min" :value="old('salary_min')" />
                                <x-input-error :messages="$errors->get('salary_min')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="salary_max" :value="__('Maximum Salary')" />
                                <x-text-input id="salary_max" class="block mt-1 w-full" type="number" name="salary_max" :value="old('salary_max')" />
